...
func (a *accountAttachmentIteratorImpl) Value() (
    *
AccountAttachment ) {
...
func (a *accountGrantIteratorImpl) Value() (
    *
AccountGrant ) {
    if a.index >= len(a.buffer) {
        return nil
...
func (a *accountIteratorImpl) Value() (
Account ) {
    if a.index >= len(a.buffer) {
        return nil
    }
...
func (r *resourceIteratorImpl) Value() (
Resource ) {
...
func (r *roleAttachmentIteratorImpl) Value() (
    *
RoleAttachment ) {
    if r.index >= len(r.buffer) {
        return nil
...
func (r *roleGrantIteratorImpl) Value() (
    *
RoleGrant ) {
    if r.index >= len(r.buffer) {
        return nil
