...
[📓browse the SDK
reference](https://pkg.go.dev/github.com/strongdm/strongdm-sdk-go/v18?tab=doc).

## Installation

```bash
$ go get github.com/strongdm/strongdm-sdk-go/v18
```
...
- Documentation: [sdm package · pkg.go.dev](https://pkg.go.dev/github.com/strongdm/strongdm-sdk-go/v18?tab=doc)
